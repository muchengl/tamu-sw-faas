...
import com.tamu.faas.utils.BillServiceClient;
...
//        billRepository.save(bill);
        ...
        BillServiceClient.addBalance(uid,money);
...
//        return  list;
        ...
        return BillServiceClient.getBills(uid);
    }

    @RequestMapping("/update/bills")
    public String updateBills(HttpServletRequest request){
        String uid=(String)request.getSession().getAttribute("userID");

        String bill   = BillServiceClient.updateBill(uid);
